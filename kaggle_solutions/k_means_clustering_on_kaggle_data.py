...
one_hot_encoded_training_predictors = pd.get_dummies(X_scaled)


# Fit the KMeans model to X_scaled and create the cluster labels
kmeans = KMeans(10, random_state=0)
X["Cluster"] = kmeans.fit_predict(one_hot_encoded_training_predictors)
...
X_cd = kmeans.fit_transform(one_hot_encoded_training_predictors)
